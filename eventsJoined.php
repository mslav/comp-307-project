...
while($row = mysqli_fetch_array($result)){
	echo '<div class="col-sm-4" style="padding-bottom:20px">' . '<form action="sendTimes.php" method="post"> <input type=\'hidden\' name="eventId" value=" ' . $row['id'] . ' " /> <input type="submit" class="btn btn btn-block" value="' . $row['name'] . '"> </form>' . '</div>'; 
}
